  ...
  return (
    <main>
      ...
      <FotoTexto
        ...
        alt="Curiosidades"
        titulo="Curiosidades sobre o casal"
      >
      ...
      <FotoTexto
        imagem={`${process.env.PUBLIC_URL}/assets/noiva.jpeg`}
        alt="Noiva"
        titulo="Sobre a Noiva"
        reverse
      >
        <p>
          Nascida em 06 de março de 2001, a noiva pisciana é formada em
          Psicologia pela Universidade Estadual de Londrina, atuando em clínica
          particular, avaliação psicológica e orientação profissional.
        </p>
        <p>
          Extremamente planejada e animada, a noiva adora cozinhar, cultivar
          plantas, pintar aquarelas e cantar. O que Alexandre mais admira na
          Carol é seu companheirismo.
        </p>
      </FotoTexto>

      <FotoTexto
        imagem={`${process.env.PUBLIC_URL}/assets/noivo.jpeg`}
        alt="Noivo"
        titulo="Sobre o Noivo"
      >
        <p>
          Nascido em 27 de outubro de 2003, o noivo é formado em Computação na
          UEL.
        </p>
        <p>
          O noivo adora tocar música, desenhar e ler. O que Carolina mais admira
          no Ale é seu jeito de ser.
        </p>
      </FotoTexto>
    </main>
  );
